...
![Version: 0.4.0](https://img.shields.io/badge/Version-0.4.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 11.4.1](https://img.shields.io/badge/AppVersion-11.4.1-informational?style=flat-square)
...
|------------|------|---------|
| https://charts.bitnami.com/bitnami | memcached | 6.0.2 |
| https://charts.bitnami.com/bitnami | redis | 16.3.0 |
...
| redis.metrics.enabled | bool | `false` | enable memcached-exporter sidecar |
